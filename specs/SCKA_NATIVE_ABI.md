...
public transitions; private initialization and transitions 1-12 implemented;
...
initialization and transitions 1-12 as specified by `SCKA_TRANSITION_ENGINE.md`,
...
remaining scheduling, recovery behavior, and transition 13 remain
