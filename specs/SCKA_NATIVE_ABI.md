...
public transitions; private initialization and transitions 1-8 implemented;
...
initialization and transitions 1-8 as specified by `SCKA_TRANSITION_ENGINE.md`,
...
remaining scheduling, recovery behavior, and transitions 9-13 remain
