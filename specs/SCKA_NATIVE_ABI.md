...
public transitions; private initialization and transitions 1-7 implemented;
...
initialization and transitions 1-7 as specified by `SCKA_TRANSITION_ENGINE.md`,
...
remaining scheduling, recovery behavior, and transitions 8-13 remain
