...
connected only to private transitions 1-4; public ABI not connected; protocol v3 inactive**
...
and `Ct2` constructors/accessors are used by the private transition slice, but it
