...
void main() {
  test('SCKA candidate receipt excludes AGPL code from the Premium base', () {
    ...
    expect(scaffold['candidateCrossCompileValidation'], <String, dynamic>{
      ...
      'androidReleaseAppBundleValidated': true,
    ...
    expect(
      ...
      <String, dynamic>{
        ...
        'vectorFormat': 'layergram-scka-cross-implementation-v3',
        'codecVectorFormat': 'layergram-scka-lb3-bm3-conformance-v1',
        ...
        'independentCanonicalLb3Vector': true,
        'independentAllElevenLb3Variants': true,
        'independentCanonicalBm3Vector': true,
        'independentAllSevenBm3Types': true,
        'opaqueContinuationVersionBindingFrozen': true,
        'opaqueContinuationDependency': 'libcrux-ml-kem=0.0.10',
        'opaqueContinuationBytes': 2080,
        'opaqueContinuationSha256':
            '4511643adc1b7e4c77b04fd83b86f8964ec8f0c92350727904811cbc325d95a0',
        'lb3BundleSha256':
            '6631ecead728fb5abcd6b5767cd49bd98325c6c321cf02aa3a9c5ab29d92e84c',
        'bm3BundleSha256':
            'a27f47390319fd04501f2632bdd4822614e09b5b1ca8755f194699e40c7fb135',
        'transcriptSha256':
    ...
    expect(
      composition['candidateAndroidReleaseAppBundleValidated'],
      isTrue,
    );
    ...
    expect(
      effects['candidateIndependentCodecConformanceVectorAdded'],
      isTrue,
    );
  ...
  test('SCKA dependencies stay permissive and packaging remains opt-in', () {
    ...
    expect(androidBundleTool, contains('PACKAGE_ID=app.layergram.sckasmoke'));
    expect(androidBundleTool, contains('layergramSckaCandidatePackage=true'));
    expect(androidBundleTool, contains('layergramSckaPhysicalSmoke=true'));
    expect(androidBundleTool, contains('BundleToolMain'));
    expect(androidBundleTool, contains('jarsigner -verify'));
    expect(androidBundleTool, isNot(contains('app.layergram\n')));
