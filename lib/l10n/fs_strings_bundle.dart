...
class FsStringsBundle {
  ...
  static const Map<String, String> _it = {
    ...
    'security.fs.new_device_detected':
        'Nuovo dispositivo o sessione rilevato per questo contatto. Una nuova sessione sicura è in fase di negoziazione.',
    'security.fs.message_lost':
        'Questo messaggio era cifrato con una sessione precedente e non può essere decifrato.',
    'security.message_not_for_me':
        'Nessun messaggio Layergram decifrabile trovato.',
    'security.fs.message_expired_fs': 'Messaggio Forward Secrecy',
    'security.fs.session_reset_done':
        'Sessione sicura reimpostata. Una nuova sessione sarà negoziata automaticamente.',
    ...
    'security.fs.mode.sheet_subtitle':
        'Scegli il livello di Forward Secrecy per questo contatto.',
    'security.fs.mode.base_title': 'Base',
    'security.fs.mode.base_desc':
        'Crittografia standard. Massima compatibilità.',
    'security.fs.mode.advanced_title': 'Avanzata',
    'security.fs.mode.advanced_desc':
        'Forward Secrecy automatica quando supportata. Fallback legacy consentito.',
    'security.fs.mode.strict_title': 'Massima',
    'security.fs.mode.strict_desc':
        'Protezione più forte. Legata al dispositivo, nessun fallback.',
    ...
    'security.fs.cls.legacy.desc':
        'Questo messaggio utilizza la crittografia d\'identità standard. Forward Secrecy non era attiva.',
    'security.fs.cls.pre_fs': 'Messaggio pre-FS',
    'security.fs.cls.pre_fs.desc':
        'Questo messaggio è stato inviato prima che Forward Secrecy fosse stabilita.',
    'security.fs.cls.negotiation': 'Negoziazione FS',
    'security.fs.cls.negotiation.desc':
        'Questo messaggio faceva parte della negoziazione dell\'handshake Forward Secrecy.',
    'security.fs.cls.fs_fallback': 'Forward Secrecy',
    'security.fs.cls.fs_fallback.desc':
        'Questo messaggio è protetto da Forward Secrecy con fallback di compatibilità consentito.',
    'security.fs.cls.fs_only': 'Solo FS',
    'security.fs.cls.fs_only.desc':
        'Questo messaggio è protetto solo da Forward Secrecy. Non può essere decifrato con la chiave legacy.',
    'security.fs.cls.strict': 'FS massima',
    'security.fs.cls.strict.desc':
        'Questo messaggio è protetto dalla Forward Secrecy massima. Il fallback legacy è disabilitato.',
    'security.fs.cls.failed': 'FS fallita',
    'security.fs.cls.failed.desc':
        'La decifratura Forward Secrecy è fallita. La sessione potrebbe essere stata reimpostata o il dispositivo cambiato.',
    'security.fs.cls.unknown': 'Sconosciuta',
    'security.fs.cls.unknown.desc':
        'La classificazione di sicurezza di questo messaggio non è stata determinata.',

    // Passphrase settings (§11.2–§11.5, §14.2)
    'security.pp.section_title': 'Sicurezza per questa identità',
    'security.pp.section_subtitle':
        'Impostazioni specifiche per questa identità derivata da passphrase.',
    'security.pp.timeout_title': 'Espulsione automatica passphrase',
    'security.pp.timeout_subtitle':
        'Scegli un timeout più breve per una protezione maggiore.',
    ...
    'security.pp.screen_lock_subtitle':
        'Distrugge le chiavi passphrase immediatamente al blocco dello schermo.',
    ...
    // §14.5 Avvertenze
    'security.warn.active_passphrase':
        'Finché questa identità è sbloccata, le sue chiavi esistono nella memoria del dispositivo. Layergram non protegge da sequestro o compromissione mentre l\'identità è attivamente sbloccata.',
    'security.warn.passphrase_fs':
        'La passphrase ripristina questa identità. Potrebbe non ripristinare i vecchi messaggi Forward Secure se lo stato della sessione è stato eliminato o scaduto.',
    'security.warn.volatile_history':
        'Questa modalità è progettata per ridurre la recuperabilità futura. I vecchi messaggi potrebbero non essere più leggibili, anche con la passphrase corretta.',
    'security.warn.ephemeral_session':
        'Lo stato FS e la cronologia sono solo in RAM. La FS si riavvia dopo ogni espulsione della passphrase. Nessun messaggio o stato di sessione sopravviverà.',
    'security.warn.recoverability_title': 'Recuperabilità ridotta',
    'security.warn.recoverability_body':
        'Questa modalità migliora la protezione riducendo quanto a lungo le vecchie chiavi o la cronologia leggibile rimangono disponibili. Se elimini messaggi, resetti sessioni, espelli questa identità, reinstalli Layergram, perdi lo stato locale o pulisci l\'archivio cifrato, alcuni messaggi più vecchi potrebbero non essere recuperabili anche se hai ancora il testo Layergram originale o la passphrase corretta.',
    'security.warn.recoverability_confirm':
        'Capisco che alcuni vecchi messaggi potrebbero diventare irrecuperabili.',

    // §13.7 Pulizia dati indecifrabili
    'security.cleanup.title': 'Pulisci dati indecifrabili',
    'security.cleanup.subtitle':
        'Rimuovi i dati residui che non possono essere decifrati.',
    'security.cleanup.dialog_title': 'Pulisci dati indecifrabili',
    'security.cleanup.dialog_body':
        'Questo potrebbe eliminare permanentemente vecchi archivi cifrati, dati di identità abbandonati, record derivati da passphrase, sessioni di sicurezza e altri dati che Layergram non può attualmente decifrare.',
    'security.cleanup.confirm_checkbox':
  ...
  static const Map<String, String> _es = {
    ...
    'security.fs.new_device_detected':
        'Nuevo dispositivo o sesión detectada para este contacto. Se está negociando una nueva sesión segura.',
    'security.fs.message_lost':
        'Este mensaje fue cifrado con una sesión anterior y no se puede descifrar.',
    'security.fs.message_expired_fs': 'Mensaje Forward Secrecy',
    'security.fs.session_reset_done':
        'Sesión segura restablecida. Se negociará una nueva sesión automáticamente.',
    ...
    'security.passphrase.fs_active':
        'Forward Secrecy de frase de contraseña activo',
    'security.passphrase.fs_inactive':
        'Contexto de frase de contraseña no activo',
    'security.passphrase.settings_visible_note':
    ...
    'security.fs.mode.sheet_subtitle':
        'Elige el nivel de Forward Secrecy para este contacto.',
    'security.fs.mode.base_title': 'Base',
    'security.fs.mode.base_desc': 'Cifrado estándar. Máxima compatibilidad.',
    'security.fs.mode.advanced_title': 'Avanzado',
    'security.fs.mode.advanced_desc':
        'Forward Secrecy automático cuando está soportado. Fallback legacy permitido.',
    'security.fs.mode.strict_title': 'Máximo',
    'security.fs.mode.strict_desc':
        'Protección más fuerte. Vinculado al dispositivo, sin fallback.',
    ...
    'security.contact.state.passphrase_context':
        'Identidad de frase de contraseña',
    ...
    'security.fs.cls.legacy.desc':
        'Este mensaje usa cifrado de identidad estándar. Forward Secrecy no estaba activo.',
    'security.fs.cls.pre_fs': 'Mensaje pre-FS',
    'security.fs.cls.pre_fs.desc':
        'Este mensaje fue enviado antes de que se estableciera Forward Secrecy.',
    'security.fs.cls.negotiation': 'Negociación FS',
    'security.fs.cls.negotiation.desc':
        'Este mensaje fue parte de la negociación del handshake de Forward Secrecy.',
    'security.fs.cls.fs_fallback': 'Forward Secrecy',
    'security.fs.cls.fs_fallback.desc':
        'Este mensaje está protegido por Forward Secrecy con compatibilidad de respaldo permitida.',
    'security.fs.cls.fs_only': 'Solo FS',
    'security.fs.cls.fs_only.desc':
        'Este mensaje está protegido solo por Forward Secrecy. No se puede descifrar con la clave legacy.',
    'security.fs.cls.strict': 'FS máximo',
    'security.fs.cls.strict.desc':
        'Este mensaje está protegido por Forward Secrecy máximo. El respaldo legacy está deshabilitado.',
    'security.fs.cls.failed': 'FS fallido',
    'security.fs.cls.failed.desc':
        'La descifrado de Forward Secrecy falló. La sesión puede haber sido restablecida o el dispositivo cambiado.',
    'security.fs.cls.unknown': 'Desconocido',
    'security.fs.cls.unknown.desc':
        'No se pudo determinar la clasificación de seguridad de este mensaje.',

    // Passphrase settings (§11.2–§11.5, §14.2)
    'security.pp.section_title': 'Seguridad para esta identidad',
    'security.pp.section_subtitle':
        'Ajustes específicos para esta identidad derivada de passphrase.',
    'security.pp.timeout_title': 'Expulsión automática de passphrase',
    'security.pp.timeout_subtitle':
        'Elige un tiempo más corto para mayor protección.',
    ...
    'security.pp.screen_lock_subtitle':
        'Destruye las claves de passphrase inmediatamente al bloquear la pantalla.',
    ...
    // §14.5 Advertencias
    'security.warn.active_passphrase':
        'Mientras esta identidad está desbloqueada, sus claves existen en la memoria del dispositivo. Layergram no protege contra incautación o compromiso mientras la identidad está activamente desbloqueada.',
    'security.warn.passphrase_fs':
        'La passphrase restaura esta identidad. Puede que no restaure mensajes Forward Secure antiguos si el estado de sesión requerido fue eliminado o expiró.',
    'security.warn.volatile_history':
        'Este modo está diseñado para reducir la recuperabilidad futura. Los mensajes antiguos pueden no ser legibles de nuevo, incluso con la passphrase correcta.',
    'security.warn.ephemeral_session':
        'El estado FS y el historial son solo en RAM. FS se reinicia después de cada expulsión de passphrase. Ningún mensaje o estado de sesión sobrevivirá.',
    'security.warn.recoverability_title': 'Recuperabilidad reducida',
    'security.warn.recoverability_body':
        'Este modo mejora la protección reduciendo cuánto tiempo las claves antiguas o el historial legible permanecen disponibles. Si eliminas mensajes, restableces sesiones, expulsas esta identidad, reinstalas Layergram, pierdes el estado local o limpias el archivo cifrado, algunos mensajes más antiguos pueden no ser recuperables incluso si aún tienes el texto Layergram original o la passphrase correcta.',
    'security.warn.recoverability_confirm':
        'Entiendo que algunos mensajes antiguos pueden volverse irrecuperables.',

    // §13.7 Limpiar datos indescifrables
    'security.cleanup.title': 'Limpiar datos indescifrables',
    'security.cleanup.subtitle':
        'Eliminar datos residuales que no pueden ser descifrados.',
    'security.cleanup.dialog_title': 'Limpiar datos indescifrables',
    'security.cleanup.dialog_body':
        'Esto puede eliminar permanentemente archivos cifrados antiguos, datos de identidad abandonados, registros derivados de passphrase, sesiones de seguridad y otros datos que Layergram no puede descifrar actualmente.',
    'security.cleanup.confirm_checkbox':
  ...
  static const Map<String, String> _de = {
    ...
    'security.fs.new_device_detected':
        'Neues Gerät oder neue Sitzung für diesen Kontakt erkannt. Eine neue sichere Sitzung wird ausgehandelt.',
    'security.fs.message_lost':
        'Diese Nachricht wurde mit einer vorherigen Sitzung verschlüsselt und kann nicht entschlüsselt werden.',
    'security.fs.message_expired_fs': 'Forward-Secrecy-Nachricht',
    'security.fs.session_reset_done':
        'Sichere Sitzung zurückgesetzt. Eine neue Sitzung wird automatisch ausgehandelt.',
    ...
    'security.fs.mode.sheet_subtitle':
        'Wählen Sie die Forward-Secrecy-Stufe für diesen Kontakt.',
    'security.fs.mode.base_title': 'Basis',
    'security.fs.mode.base_desc':
        'Standardverschlüsselung. Maximale Kompatibilität.',
    'security.fs.mode.advanced_title': 'Erweitert',
    'security.fs.mode.advanced_desc':
        'Automatische Forward Secrecy wenn unterstützt. Legacy-Fallback erlaubt.',
    'security.fs.mode.strict_title': 'Maximum',
    'security.fs.mode.strict_desc':
        'Stärkster Schutz. Gerätegebunden, kein Fallback.',
    ...
    'security.fs.cls.legacy.desc':
        'Diese Nachricht verwendet Standard-Identitätsverschlüsselung. Forward Secrecy war nicht aktiv.',
    'security.fs.cls.pre_fs': 'Vor-FS-Nachricht',
    'security.fs.cls.pre_fs.desc':
        'Diese Nachricht wurde gesendet, bevor Forward Secrecy eingerichtet wurde.',
    'security.fs.cls.negotiation': 'FS-Aushandlung',
    'security.fs.cls.negotiation.desc':
        'Diese Nachricht war Teil der Forward Secrecy Handshake-Aushandlung.',
    'security.fs.cls.fs_fallback': 'Forward Secrecy',
    'security.fs.cls.fs_fallback.desc':
        'Diese Nachricht ist durch Forward Secrecy mit erlaubtem Kompatibilitäts-Fallback geschützt.',
    'security.fs.cls.fs_only': 'Nur FS',
    'security.fs.cls.fs_only.desc':
        'Diese Nachricht ist nur durch Forward Secrecy geschützt. Sie kann nicht mit dem Legacy-Schlüssel entschlüsselt werden.',
    'security.fs.cls.strict': 'Maximale FS',
    'security.fs.cls.strict.desc':
        'Diese Nachricht ist durch maximale Forward Secrecy geschützt. Legacy-Fallback ist deaktiviert.',
    'security.fs.cls.failed': 'FS fehlgeschlagen',
    'security.fs.cls.failed.desc':
        'Die Forward Secrecy Entschlüsselung ist fehlgeschlagen. Die Sitzung wurde möglicherweise zurückgesetzt oder das Gerät gewechselt.',
    'security.fs.cls.unknown': 'Unbekannt',
    'security.fs.cls.unknown.desc':
        'Die Sicherheitsklassifizierung dieser Nachricht konnte nicht bestimmt werden.',

    // Passphrase settings (§11.2–§11.5, §14.2)
    'security.pp.section_title': 'Sicherheit für diese Identität',
    'security.pp.section_subtitle':
        'Einstellungen für diese passphrase-abgeleitete Identität.',
    'security.pp.timeout_title': 'Passphrase automatisch löschen',
    'security.pp.timeout_subtitle':
        'Wähle ein kürzeres Timeout für stärkeren Schutz.',
    ...
    'security.pp.screen_lock_subtitle':
        'Zerstört die Passphrase-Schlüssel sofort bei Bildschirmsperre.',
    ...
    // §14.5 Warnungen
    'security.warn.active_passphrase':
        'Solange diese Identität entsperrt ist, existieren ihre Schlüssel im Gerätespeicher. Layergram schützt nicht vor Beschlagnahme oder Kompromittierung, während die Identität aktiv entsperrt ist.',
    'security.warn.passphrase_fs':
        'Die Passphrase stellt diese Identität wieder her. Sie stellt möglicherweise keine alten Forward-Secure-Nachrichten wieder her, wenn der erforderliche Sitzungsstatus gelöscht oder abgelaufen ist.',
    'security.warn.volatile_history':
        'Dieser Modus ist darauf ausgelegt, die zukünftige Wiederherstellbarkeit zu reduzieren. Alte Nachrichten sind möglicherweise nicht mehr lesbar, auch nicht mit der richtigen Passphrase.',
    'security.warn.ephemeral_session':
        'FS-Status und Verlauf sind nur im RAM. FS startet nach jeder Passphrase-Ausweisung neu. Keine Nachrichten oder Sitzungsstatus überleben.',
    'security.warn.recoverability_title': 'Reduzierte Wiederherstellbarkeit',
    'security.warn.recoverability_body':
        'Dieser Modus verbessert den Schutz, indem er reduziert, wie lange alte Schlüssel oder lesbarer Verlauf verfügbar bleiben. Wenn Sie Nachrichten löschen, Sitzungen zurücksetzen, diese Identität ausweisen, Layergram neu installieren, den lokalen Status verlieren oder das verschlüsselte Archiv bereinigen, sind einige ältere Nachrichten möglicherweise nicht wiederherstellbar, auch wenn Sie noch den originalen Layergram-Text oder die richtige Passphrase haben.',
    'security.warn.recoverability_confirm':
        'Ich verstehe, dass einige alte Nachrichten unwiederbringlich werden können.',

    // §13.7 Unentschlüsselbare Daten bereinigen
    'security.cleanup.title': 'Unentschlüsselbare Daten bereinigen',
    'security.cleanup.subtitle':
        'Restdaten entfernen, die nicht entschlüsselt werden können.',
    'security.cleanup.dialog_title': 'Unentschlüsselbare Daten bereinigen',
    'security.cleanup.dialog_body':
        'Dies kann dauerhaft alte verschlüsselte Archive, aufgegebene Identitätsdaten, von Passphrase abgeleitete Datensätze, Sicherheitssitzungen und andere Daten löschen, die Layergram derzeit nicht entschlüsseln kann.',
    'security.cleanup.confirm_checkbox':
        'Ich verstehe, dass diese Aktion irreversibel ist.',
  ...
  static const Map<String, String> _fr = {
    ...
    'security.fs.new_device_detected':
        'Nouvel appareil ou session détecté pour ce contact. Une nouvelle session sécurisée est en cours de négociation.',
    'security.fs.message_lost':
        'Ce message a été chiffré avec une session précédente et ne peut pas être déchiffré.',
    'security.fs.message_expired_fs': 'Message Forward Secrecy',
    'security.fs.session_reset_done':
        'Session sécurisée réinitialisée. Une nouvelle session sera négociée automatiquement.',
    ...
    'security.fs.mode.sheet_subtitle':
        'Choisissez le niveau de Forward Secrecy pour ce contact.',
    'security.fs.mode.base_title': 'Base',
    'security.fs.mode.base_desc':
        'Chiffrement standard. Compatibilité maximale.',
    'security.fs.mode.advanced_title': 'Avancé',
    'security.fs.mode.advanced_desc':
        'Forward Secrecy automatique lorsque supporté. Repli legacy autorisé.',
    'security.fs.mode.strict_title': 'Maximum',
    'security.fs.mode.strict_desc':
        'Protection la plus forte. Lié à l\'appareil, sans repli.',
    ...
    'security.fs.cls.legacy.desc':
        'Ce message utilise le chiffrement d\'identité standard. Forward Secrecy n\'était pas actif.',
    'security.fs.cls.pre_fs': 'Message pré-FS',
    'security.fs.cls.pre_fs.desc':
        'Ce message a été envoyé avant l\'établissement de Forward Secrecy.',
    'security.fs.cls.negotiation': 'Négociation FS',
    'security.fs.cls.negotiation.desc':
        'Ce message faisait partie de la négociation du handshake Forward Secrecy.',
    'security.fs.cls.fs_fallback': 'Forward Secrecy',
    'security.fs.cls.fs_fallback.desc':
        'Ce message est protégé par Forward Secrecy avec repli de compatibilité autorisé.',
    'security.fs.cls.fs_only': 'FS uniquement',
    'security.fs.cls.fs_only.desc':
        'Ce message est protégé uniquement par Forward Secrecy. Il ne peut pas être déchiffré avec la clé legacy.',
    'security.fs.cls.strict': 'FS maximum',
    'security.fs.cls.strict.desc':
        'Ce message est protégé par Forward Secrecy maximum. Le repli legacy est désactivé.',
    'security.fs.cls.failed': 'FS échoué',
    'security.fs.cls.failed.desc':
        'Le déchiffrement Forward Secrecy a échoué. La session a peut-être été réinitialisée ou l\'appareil changé.',
    'security.fs.cls.unknown': 'Inconnu',
    'security.fs.cls.unknown.desc':
        'La classification de sécurité de ce message n\'a pas pu être déterminée.',

    // Passphrase settings (§11.2–§11.5, §14.2)
    'security.pp.section_title': 'Sécurité pour cette identité',
    'security.pp.section_subtitle':
        'Paramètres spécifiques à cette identité dérivée de la passphrase.',
    'security.pp.timeout_title': 'Expulsion automatique de la passphrase',
    'security.pp.timeout_subtitle':
        'Choisissez un délai plus court pour une protection renforcée.',
    ...
    'security.pp.screen_lock_subtitle':
        'Détruit les clés de passphrase immédiatement lors du verrouillage de l\'écran.',
    ...
    // §14.5 Avertissements
    'security.warn.active_passphrase':
        'Tant que cette identité est déverrouillée, ses clés existent dans la mémoire de l\'appareil. Layergram ne protège pas contre la saisie ou la compromission tant que l\'identité est activement déverrouillée.',
    'security.warn.passphrase_fs':
        'La passphrase restaure cette identité. Elle pourrait ne pas restaurer les anciens messages Forward Secure si l\'état de session requis a été supprimé ou a expiré.',
    'security.warn.volatile_history':
        'Ce mode est conçu pour réduire la récupérabilité future. Les anciens messages pourraient ne plus être lisibles, même avec la bonne passphrase.',
    'security.warn.ephemeral_session':
        'L\'état FS et l\'historique sont uniquement en RAM. La FS redémarre après chaque expulsion de passphrase. Aucun message ou état de session ne survivra.',
    ...
    'security.warn.recoverability_confirm':
        'Je comprends que certains anciens messages pourraient devenir irrécupérables.',

    // §13.7 Nettoyer les données indéchiffrables
    'security.cleanup.title': 'Nettoyer les données indéchiffrables',
    'security.cleanup.subtitle':
        'Supprimer les données résiduelles qui ne peuvent pas être déchiffrées.',
    'security.cleanup.dialog_title': 'Nettoyer les données indéchiffrables',
    'security.cleanup.dialog_body':
        'Cela peut supprimer définitivement d\'anciennes archives chiffrées, des données d\'identité abandonnées, des enregistrements dérivés de passphrase, des sessions de sécurité et d\'autres données que Layergram ne peut pas actuellement déchiffrer.',
    'security.cleanup.confirm_checkbox':
  ...
  static const Map<String, String> _pt = {
    ...
    'security.fs.new_device_detected':
        'Novo dispositivo ou sessão detectado para este contato. Uma nova sessão segura está sendo negociada.',
    'security.fs.message_lost':
        'Esta mensagem foi criptografada com uma sessão anterior e não pode ser descriptografada.',
    'security.fs.message_expired_fs': 'Mensagem Forward Secrecy',
    'security.fs.session_reset_done':
        'Sessão segura redefinida. Uma nova sessão será negociada automaticamente.',
    ...
    'security.fs.mode.sheet_subtitle':
        'Escolha o nível de Forward Secrecy para este contato.',
    'security.fs.mode.base_title': 'Base',
    'security.fs.mode.base_desc':
        'Criptografia padrão. Máxima compatibilidade.',
    'security.fs.mode.advanced_title': 'Avançado',
    'security.fs.mode.advanced_desc':
        'Forward Secrecy automático quando suportado. Fallback legacy permitido.',
    'security.fs.mode.strict_title': 'Máximo',
    'security.fs.mode.strict_desc':
        'Proteção mais forte. Vinculado ao dispositivo, sem fallback.',
    'security.fs.mode.confirm_button': 'Aplicar',
    'security.fs.mode.cancel_button': 'Cancelar',
    ...
    'security.fs.cls.legacy.desc':
        'Esta mensagem usa criptografia de identidade padrão. Forward Secrecy não estava ativo.',
    'security.fs.cls.pre_fs': 'Mensagem pré-FS',
    'security.fs.cls.pre_fs.desc':
        'Esta mensagem foi enviada antes do Forward Secrecy ser estabelecido.',
    'security.fs.cls.negotiation': 'Negociação FS',
    'security.fs.cls.negotiation.desc':
        'Esta mensagem fez parte da negociação do handshake Forward Secrecy.',
    'security.fs.cls.fs_fallback': 'Forward Secrecy',
    'security.fs.cls.fs_fallback.desc':
        'Esta mensagem é protegida por Forward Secrecy com fallback de compatibilidade permitido.',
    'security.fs.cls.fs_only': 'Apenas FS',
    'security.fs.cls.fs_only.desc':
        'Esta mensagem é protegida apenas por Forward Secrecy. Não pode ser decifrada com a chave legacy.',
    'security.fs.cls.strict': 'FS máximo',
    'security.fs.cls.strict.desc':
        'Esta mensagem é protegida por Forward Secrecy máximo. O fallback legacy está desabilitado.',
    'security.fs.cls.failed': 'FS falhou',
    'security.fs.cls.failed.desc':
        'A decifragem Forward Secrecy falhou. A sessão pode ter sido redefinida ou o dispositivo alterado.',
    'security.fs.cls.unknown': 'Desconhecido',
    'security.fs.cls.unknown.desc':
        'A classificação de segurança desta mensagem não pôde ser determinada.',

    // Passphrase settings (§11.2–§11.5, §14.2)
    'security.pp.section_title': 'Segurança para esta identidade',
    'security.pp.section_subtitle':
        'Configurações específicas para esta identidade derivada de passphrase.',
    'security.pp.timeout_title': 'Expulsão automática da passphrase',
    'security.pp.timeout_subtitle':
        'Escolha um tempo mais curto para maior proteção.',
    'security.pp.timeout_30s': '30 segundos',
    'security.pp.timeout_1m': '1 minuto',
    'security.pp.timeout_2m': '2 minutos',
    'security.pp.timeout_5m': '5 minutos',
    ...
    'security.pp.screen_lock_subtitle':
        'Destrói as chaves da passphrase imediatamente ao bloquear a tela.',
    ...
    // §14.5 Avisos
    'security.warn.active_passphrase':
        'Enquanto esta identidade estiver desbloqueada, suas chaves existem na memória do dispositivo. Layergram não protege contra apreensão ou comprometimento enquanto a identidade está ativamente desbloqueada.',
    'security.warn.passphrase_fs':
        'A passphrase restaura esta identidade. Ela pode não restaurar mensagens Forward Secure antigas se o estado de sessão necessário foi excluído ou expirou.',
    'security.warn.volatile_history':
        'Este modo é projetado para reduzir a recuperabilidade futura. Mensagens antigas podem não ser legíveis novamente, mesmo com a passphrase correta.',
    'security.warn.ephemeral_session':
        'O estado FS e o histórico são apenas em RAM. A FS reinicia após cada expulsão de passphrase. Nenhuma mensagem ou estado de sessão sobreviverá.',
    'security.warn.recoverability_title': 'Recuperabilidade reduzida',
    'security.warn.recoverability_body':
        'Este modo melhora a proteção reduzindo quanto tempo as chaves antigas ou o histórico legível permanecem disponíveis. Se você excluir mensagens, redefinir sessões, expulsar esta identidade, reinstalar o Layergram, perder o estado local ou limpar o arquivo criptografado, algumas mensagens mais antigas podem não ser recuperáveis mesmo se você ainda tiver o texto Layergram original ou a passphrase correta.',
    'security.warn.recoverability_confirm':
        'Entendo que algumas mensagens antigas podem se tornar irrecuperáveis.',

    // §13.7 Limpar dados indecifráveis
    'security.cleanup.title': 'Limpar dados indecifráveis',
    'security.cleanup.subtitle':
        'Remover dados residuais que não podem ser decifrados.',
    'security.cleanup.dialog_title': 'Limpar dados indecifráveis',
    'security.cleanup.dialog_body':
        'Isso pode excluir permanentemente arquivos criptografados antigos, dados de identidade abandonados, registros derivados de passphrase, sessões de segurança e outros dados que o Layergram não pode atualmente decifrar.',
    'security.cleanup.confirm_checkbox':
