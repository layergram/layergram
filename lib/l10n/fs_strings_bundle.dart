...
class FsStringsBundle {
  ...
  static const Map<String, String> _en = {
    ...
    // Protocol v3 application security
    'security.fs.v3.card_title': 'Post-quantum security',
    'security.fs.v3.normal_title': 'Normal',
    'security.fs.v3.normal_desc':
        'Post-quantum protection with automatic sessions for multiple devices.',
    'security.fs.v3.maximum_desc':
        'Post-quantum protection bound to the newest confirmed device session.',
    'security.fs.v3.status.setup_required': 'Secure setup required',
    'security.fs.v3.status.setup_pending': 'Secure setup pending',
    ...
    'security.fs.v3.description.maximum_active':
        'Messages use the hybrid v3 ratchet and only the newest confirmed device session is selected.',
    'security.fs.v3.active_sessions': '{count} active device sessions',
    'security.fs.v3.mode_changed':
        'Security mode changed. Exchange the new setup message before sending content.',
    'security.fs.v3.reset_title': 'Create a new secure session?',
    'security.fs.v3.reset_body':
        'Existing sessions will no longer be used for new content. Delayed setup or message parts from them may not complete.',
    'security.fs.v3.migration_title': 'Your new post-quantum identity',
    'security.fs.v3.migration_body':
        'Your same 24 recovery words now reproduce a new v3 public identity. Share this new identity with your contacts and verify it again; old public identities and sessions are not compatible with v3.',
    'security.fs.v3.migration_later': 'Later',
    'security.fs.v3.migration_view_identity': 'View and share identity',
    'security.fs.v3.contact_migration_title':
        'This contact still uses an old identity',
    'security.fs.v3.contact_migration_required':
        'Ask this person to share their new v3 public identity, then import and verify it again. New v2 messages are disabled after the post-quantum migration.',
    'security.fs.v3.identity_import_required':
        'This is an old Layergram identity. Ask for the new post-quantum v3 identity.',
